...
class App extends Component {
  ...
  render() {
    ...
    <nav class="navbar fixed-top">
            <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
                <a class="inline-block mr-4 py-0.5 text-xl whitespace-nowrap hover:no-underline focus:no-underline" href="#youarehome">
                    <img src={require("./images/ijusticelogo.svg")} id='imgsize' alt="alternative" class="h-8" />
                </a>
                ...
                <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center" id="navbarsExampleDefault">
                    <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                        ...
                        <li>
                            <a class="nav-link page-scroll" href="#details">Safety & Education</a>
                        </li>
                        <li>
    ...
    <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
      <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
          <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
              <h1 class="h1-large mb-5">iJustice</h1>
              <p class="p-large mb-8">A sex offenders registry that provides information about convicted sex offenders.</p>
              <a class="btn-solid-lg" href="#your-link"><i class="fab fa-apple"></i>Get Started</a>
          </div>
          <div class="xl:text-right">
              <img class="inline"  src={require("./images/ijust3.jpg")} alt="alternative" />
          </div>
      </div> 
  </header> 
  ...
  <div class="pt-4 pb-14 text-center">
            <div class="container px-4 sm:px-8 xl:px-4">
                <p class="mb-4 text-gray-800 text-3xl leading-10 lg:max-w-5xl lg:mx-auto"> Recently, victims’ advocates and others have argued
                that persons convicted of sex offenses are highly likely to reoffend by committing
                another sex crime hence we are not safe.</p>
            </div> 
        </div>
            ...
            <div class="container px-4 sm:px-8 xl:px-4">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src={require("./images/features-icon-1.svg")} alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src={require("./images/features-icon-2.svg")} alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src={require("./images/features-icon-3.svg")} alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src={require("./images/features-icon-4.svg")} alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src={require("./images/features-icon-5.svg")} alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src={require("./images/features-icon-6.svg")} alt="alternative" />
                    </div>
                    <div class="card-body">
        ...
        <div id="details" class="pt-12 pb-16 lg:pt-16">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                ...
                <div class="lg:col-span-7">
                    <div class="xl:ml-14">
                        <img class="inline" src={require("./images/details-1.jpg")} alt="alternative" />
                    </div>
                </div>
            </div> 
        </div>
            ...
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                <div class="lg:col-span-7">
                    <div class="mb-12 lg:mb-0 xl:mr-14">
                        <img class="inline" src={require("./images/details-2.jpg")} alt="alternative" />
                    </div>
                </div> 
                <div class="lg:col-span-5">
                    <div class="xl:mt-12">
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
                ...
                <div class="lg:col-span-8">
                    <div class="mb-12 text-center lg:mb-0 lg:text-left xl:mr-6">
                        <img class="inline rounded-lg" src={require("./images/details-lightbox.jpg")} alt="alternative" />
                    </div>
                </div> 
        ...
        <div class="pt-16 pb-12">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                ...
                <div class="lg:col-span-7">
                    <div class="ml-14">
                        <img class="inline" src={require("./images/details-3.jpg")} alt="alternative" />
                    </div>
                </div> 
            </div> 
        </div>
                    ...
                    <div class="swiper-container card-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src={require("./images/testimonial-1.jpg")} alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src={require("./images/testimonial-2.jpg")} alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src={require("./images/testimonial-3.jpg")} alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src={require("./images/testimonial-4.jpg")} alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src={require("./images/testimonial-5.jpg")} alt="alternative" />
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src={require("./images/testimonial-6.jpg")} alt="alternative" />
                                    <div class="card-body">
        ...
        <div id="download" class="basic-5">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2">
                <div class="mb-16 lg:mb-0">
                    <img src={require("./images/conclusion-smartphone.png")} alt="alternative" />
                </div>
